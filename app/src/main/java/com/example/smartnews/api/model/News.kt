...
data class News(
    ...
    private fun String.containsPositiveKeywords(): Boolean {
        val keywords = setOf(
            // Core positive emotions and states
            ...
            // Economic and material positivity
    ...
    private fun String.containsNegativeKeywords(): Boolean {
        val keywords = setOf(
            // Core negative emotions and states
            ...
            // Economic and material negativity
